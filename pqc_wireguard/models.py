"""
Data Models & Telemetry Definitions for PQC-WireGuard: Hybrid Post-Quantum Tunneling & Key Negotiation Supervisor.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "IETF Noise Protocol & PQC Hybrid Extension"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
