...
import pytest
from pqc_wireguard.models import FrontierPayload, ExecutionStatus
from pqc_wireguard.engine import FrontierDomainEngine
from pqc_wireguard.agents import NoiseHandshakeAuditorAgent, MLKEMRatchetRotatorAgent, ReplayWindowDefenseAgent, PQCWireguardCoordinator
from pqc_wireguard.cli import main


def test_sub_agents():
    a1 = NoiseHandshakeAuditorAgent()
...
def test_coordinator():
    ...
    assert "IETF Noise Protocol & PQC Hybrid Extension" in ans or "specifications" in ans
