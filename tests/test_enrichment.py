"""
Automated Pytest for post-quantum-vpn-wireguard-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    PostquantumvpnwireguardagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = PostquantumvpnwireguardagentEnrichmentSuite()
